...
function renderPost(post) {
  ...
  <div class="post">
    ...
    <div class="profile-img">
      <img
        src="${BASE_PLACEHOLD_URL + post.title.split(" ")[0]}" alt="profile"
      />
    </div>
    <div class="post-middle">
              <div class="post-header">
                <h2>Julius Rock</h2>
                <span class="username">@juliusrock</span>
                <span class="dot">.</span>
                <span class="time">2021 jan 31</span>
                <button>
...
function toggleComments(event) {
  ...
  // Find the comments section within the post
